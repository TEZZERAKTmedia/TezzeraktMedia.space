...
import introVideoSrc from '../assets/Videos/IntroLeft.webm'; // Path to the intro video
import loopVideoSrc from '../assets/Videos/LoopLeft.webm'; // Path to the looping video
